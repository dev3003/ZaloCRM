<template>
  <v-card class="pa-6" elevation="8">
    ...
    <v-form @submit.prevent="handleSetup" ref="form">
      ...
      <v-text-field v-model="password" label="Mật khẩu" :type="showPassword ? 'text' : 'password'" prepend-inner-icon="mdi-lock" :append-inner-icon="showPassword ? 'mdi-eye' : 'mdi-eye-off'" @click:append-inner="showPassword = !showPassword" :rules="[v => v.length >= 6 || 'Tối thiểu 6 ký tự']" class="mb-4" />
